...
namespace CCU.Systems.CustomGoals
{
	class CustomGoals
    {
        ...
        internal static List<string> SceneSetters_Active = new List<string>()
        {
            Arrested,
            Burned,
            Dead,
        ...
        internal static List<string> SceneSetters_All = new List<string>() 
        {
            Arrested,
            Burned,
            Dead,
        ...
        internal static List<string> ActualGoals_Active = new List<string>()
        {
            //      Custom
        ...
        internal static void RunSceneSetters()
        {
        ...
        internal static List<string> CustomGoalList(List<string> vanillaList) =>
            vanillaList
    ...
    internal static class P_LoadLevel
    {
        private static readonly ManualLogSource logger = CCULogger.GetLogger();
        internal static GameController GC => GameController.gameController;

        [HarmonyPostfix, HarmonyPatch(methodName: nameof(LoadLevel.SetupMore5))]
        internal static void SetupMore5_Postfix()
        {
