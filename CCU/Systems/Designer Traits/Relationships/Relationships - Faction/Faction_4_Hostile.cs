...
namespace CCU.Traits.Rel_Faction
{
	public class Faction_4_Hostile : T_Rel_Faction
	{
		...
		{
			PostProcess_DesignerTrait = RogueLibs.CreateCustomTrait<Faction_4_Hostile>()
				.WithDescription(new CustomNameInfo
				{
					[LanguageCode.English] = "This character is Hostile to all characters aligned with Faction 4.",
					[LanguageCode.Spanish] = "Este personaje es hostil a todo quien sea Aliado de La Facción 4.",

				})
				.WithName(new CustomNameInfo
				{
					[LanguageCode.English] = DesignerName(typeof(Faction_4_Hostile)),
					[LanguageCode.Spanish] = "Hostil a la Facción 4",
