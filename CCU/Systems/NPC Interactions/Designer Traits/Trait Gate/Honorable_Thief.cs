...
namespace CCU.Traits.Trait_Gate
{
	...
	{
		public static bool CountsAsThief(Agent interactingAgent) =>
			interactingAgent.statusEffects.hasTrait(VanillaTraits.HonorAmongThieves) 
			|| interactingAgent.statusEffects.hasTrait(VanillaTraits.HonorAmongThieves + "2");
