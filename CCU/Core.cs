...
namespace CCU
{
    ...
    public static class cTrait
	{
        public const string
            ...
            Appearance_SkinColor_SuperPale = "Appearance_SkinColor_SuperPale",
            Appearance_SkinColor_Pale = "Appearance_SkinColor_Pale",
            Appearance_SkinColor_White = "Appearance_SkinColor_White",
            Appearance_SkinColor_Pink = "Appearance_SkinColor_Pink",
            Appearance_SkinColor_Gold = "Appearance_SkinColor_Gold",
            Appearance_SkinColor_Mixed = "Appearance_SkinColor_Mixed",
            Appearance_SkinColor_LightBlack = "Appearance_SkinColor_LightBlack",
            Appearance_SkinColor_Black = "Appearance_SkinColor_Black",
            Appearance_SkinColor_Zombie_1 = "Appearance_SkinColor_Zombie_1",
            Appearance_SkinColor_Zombie_2 = "Appearance_SkinColor_Zombie_2",
