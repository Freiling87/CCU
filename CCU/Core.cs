...
namespace CCU
{
    ...
    public static class CTrait 
	{
		...
		#region Appearance
		#region Accessory
			Appearance_Accessory_CopHat = "[CCU] Appearance: Accessory - Cop Hat",
			Appearance_Accessory_DoctorHeadlamp = "[CCU] Appearance: Accessory - Doctor Headlamp",
			Appearance_Accessory_Fedora = "[CCU] Appearance: Accessory - Fedora",
			Appearance_Accessory_FireHelmet = "[CCU] Appearance: Accessory - Fire Helmet",
			Appearance_Accessory_HackerGlasses = "[CCU] Appearance: Accessory - Hacker Glasses",
			Appearance_Accessory_HatBlue = "[CCU] Appearance: Accessory - Hat (Blue)",
			Appearance_Accessory_HatRed = "[CCU] Appearance: Accessory - Hat (Red)",
			Appearance_Accessory_Headphones = "[CCU] Appearance: Accessory - Headphones",
			Appearance_Accessory_None = "[CCU] Appearance: Accessory - None",
			Appearance_Accessory_Sunglasses = "[CCU] Appearance: Accessory - Sunglasses",
			Appearance_Accessory_SupercopHat = "[CCU] Appearance: Accessory - Supercop Hat",
			Appearance_Accessory_ThiefHat = "[CCU] Appearance: Accessory - Thief Hat",
		#endregion
		#region Eyes

		#endregion
		#region Facial Hair
			Appearance_FacialHair_Beard = "[CCU] Appearance: Facial Hair - Beard",
			Appearance_FacialHair_Mustache = "[CCU] Appearance: Facial Hair - Mustache",
			Appearance_FacialHair_MustacheCircus = "[CCU] Appearance: Facial Hair - MustacheCircus",
			Appearance_FacialHair_MustacheRedneck = "[CCU] Appearance: Facial Hair - MustacheRedneck",
			Appearance_FacialHair_None = "[CCU] Appearance: Facial Hair - None",
		#endregion
		#region Hair Color
			Appearance_HairColor_Brown = "[CCU] Appearance: Hair Color - Brown",
			Appearance_HairColor_Black = "[CCU] Appearance: Hair Color - Black",
			Appearance_HairColor_Blonde = "[CCU] Appearance: Hair Color - Blonde",
			Appearance_HairColor_Blue = "[CCU] Appearance: Hair Color - Blue",
			Appearance_HairColor_Green = "[CCU] Appearance: Hair Color - Green",
			Appearance_HairColor_Grey = "[CCU] Appearance: Hair Color - Grey",
			Appearance_HairColor_Orange = "[CCU] Appearance: Hair Color - Orange",
			Appearance_HairColor_Pink = "[CCU] Appearance: Hair Color - Pink",
			Appearance_HairColor_Purple = "[CCU] Appearance: Hair Color - Purple",
			Appearance_HairColor_Red = "[CCU] Appearance: Hair Color - Red",
		#endregion
		#region Hairstyle
			Appearance_Hairstyle_Afro = "[CCU] Appearance: Hairstyle - Afro",
			Appearance_Hairstyle_AlienHead = "[CCU] Appearance: Hairstyle - Alien Head",
			Appearance_Hairstyle_AssassinMask = "[CCU] Appearance: Hairstyle - Assassin Mask",
			Appearance_Hairstyle_Bald = "[CCU] Appearance: Hairstyle - Bald",
			Appearance_Hairstyle_Balding = "[CCU] Appearance: Hairstyle - Balding",
			Appearance_Hairstyle_BangsLong = "[CCU] Appearance: Hairstyle - BangsLong",
			Appearance_Hairstyle_BangsMedium = "[CCU] Appearance: Hairstyle - BangsMedium",
			Appearance_Hairstyle_ButlerBotHead = "[CCU] Appearance: Hairstyle - Butler Bot Head",
			Appearance_Hairstyle_Curtains = "[CCU] Appearance: Hairstyle - Curtains",
			Appearance_Hairstyle_Cutoff = "[CCU] Appearance: Hairstyle - Cutoff",
			Appearance_Hairstyle_FlatLong = "[CCU] Appearance: Hairstyle - FlatLong",
			Appearance_Hairstyle_GorillaHead = "[CCU] Appearance: Hairstyle - Gorilla Head",
			Appearance_Hairstyle_HoboBeard = "[CCU] Appearance: Hairstyle - HoboBeard",
			Appearance_Hairstyle_Hoodie = "[CCU] Appearance: Hairstyle - Hoodie",
			Appearance_Hairstyle_Leia = "[CCU] Appearance: Hairstyle - Leia",
			Appearance_Hairstyle_MessyLong = "[CCU] Appearance: Hairstyle - MessyLong",
			Appearance_Hairstyle_Military = "[CCU] Appearance: Hairstyle - Military",
			Appearance_Hairstyle_Mohawk = "[CCU] Appearance: Hairstyle - Mohawk",
			Appearance_Hairstyle_Normal = "[CCU] Appearance: Hairstyle - Normal",
			Appearance_Hairstyle_NormalHigh = "[CCU] Appearance: Hairstyle - NormalHigh",
			Appearance_Hairstyle_Pompadour = "[CCU] Appearance: Hairstyle - Pompadour",
			Appearance_Hairstyle_Ponytail = "[CCU] Appearance: Hairstyle - Ponytail",
			Appearance_Hairstyle_PuffyLong = "[CCU] Appearance: Hairstyle - PuffyLong",
			Appearance_Hairstyle_PuffyShort = "[CCU] Appearance: Hairstyle - PuffyShort",
			Appearance_Hairstyle_RobotHead = "[CCU] Appearance: Hairstyle - Robot Head",
			Appearance_Hairstyle_Sidewinder = "[CCU] Appearance: Hairstyle - Sidewinder",
			Appearance_Hairstyle_SlavemasterMask = "[CCU] Appearance: Hairstyle - Slavemaster Mask",
			Appearance_Hairstyle_Spiky = "[CCU] Appearance: Hairstyle - Spiky",
			Appearance_Hairstyle_SpikyShort = "[CCU] Appearance: Hairstyle - SpikyShort",
			Appearance_Hairstyle_Suave = "[CCU] Appearance: Hairstyle - Suave",
			Appearance_Hairstyle_Wave = "[CCU] Appearance: Hairstyle - Wave",
			Appearance_Hairstyle_WerewolfHead = "[CCU] Appearance: Hairstyle - Werewolf Head",
		#endregion
		#region Skin Color
			Appearance_SkinColor_SuperPaleSkin = "[CCU] Appearance: Skin Color - SuperPaleSkin",
			Appearance_SkinColor_PaleSkin = "[CCU] Appearance: Skin Color - PaleSkin",
			Appearance_SkinColor_WhiteSkin = "[CCU] Appearance: Skin Color - WhiteSkin",
			Appearance_SkinColor_PinkSkin = "[CCU] Appearance: Skin Color - PinkSkin",
			Appearance_SkinColor_GoldSkin = "[CCU] Appearance: Skin Color - GoldSkin",
			Appearance_SkinColor_MixedSkin = "[CCU] Appearance: Skin Color - MixedSkin",
			Appearance_SkinColor_LightBlackSkin = "[CCU] Appearance: Skin Color - LightBlackSkin",
			Appearance_SkinColor_BlackSkin = "[CCU] Appearance: Skin Color - BlackSkin",
			Appearance_SkinColor_ZombieSkin1 = "[CCU] Appearance: Skin Color - ZombieSkin1",
