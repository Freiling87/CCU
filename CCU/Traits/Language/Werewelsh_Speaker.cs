...
{
    public class Werewelsh_Speaker : T_Language
    {
        ...
        {
            PostProcess = RogueLibs.CreateCustomTrait<Werewelsh_Speaker>()
                ...
                {
                    [LanguageCode.English] = DisplayName(typeof(Werewelsh_Speaker)),
                })
